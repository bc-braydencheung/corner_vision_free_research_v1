...
const modelCards = <ModelCard>[
  ...
  ModelCard(
    ...
    limits:
        '免費歷史無 xG（已驗證 Understat 改為前端載入、FBref 拒絕存取），'
        '射門量只是進攻壓力的粗代理；'
        '免費賽程不含賽前裁判編排，故裁判項只在賽後歷史中生效，賽前為中性；'
  ...
  ModelCard(
    name: '六合彩顛覆模式（隨機性審計）',
    purpose: '量度可預測性的物理上界，而不是預測號碼。',
    data: '香港六合彩公開歷史開獎、各獎級中獎人數。',
    method:
        '混合時間／spectral gap 檢定、隨機矩陣 level-spacing 檢定、'
        '大偏差界；投注側以人群密度逆推最小化分帳人數。',
    gate: '所有檢定結果以 Bayes factor／p 值原樣呈現，不轉換為號碼建議。',
    limits:
        '任何真實機械偏差在可得樣本量下都無法被偵測；'
        '模式不提供、也不可能提供中獎機率的提升。',
  ),
];
